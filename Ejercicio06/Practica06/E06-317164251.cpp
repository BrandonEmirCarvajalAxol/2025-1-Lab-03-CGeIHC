...
// average normals
	GLfloat cubo_vertices[] = {
		...
		0.5f, -0.5f,  0.5f,		0.73f,	0.34f,		0.0f,	0.0f,	-1.0f,	//1
		0.5f,  0.5f,  0.5f,		0.73f,	0.66f,		0.0f,	0.0f,	-1.0f,	//2
		-0.5f,  0.5f,  0.5f,	0.51f,	0.66f,		0.0f,	0.0f,	-1.0f,	//3
		// right
		//x		y		z		S		T
		0.5f, -0.5f,  0.5f,	    0.75f,  0.34f,		-1.0f,	0.0f,	0.0f,	//4
		0.5f, -0.5f,  -0.5f,	0.99f,	0.34f,		-1.0f,	0.0f,	0.0f,	//5
		0.5f,  0.5f,  -0.5f,	0.99f,	0.65f,		-1.0f,	0.0f,	0.0f,	//6
		0.5f,  0.5f,  0.5f,	    0.75f,	0.65f,		-1.0f,	0.0f,	0.0f,	//7
		// back
		-0.5f, -0.5f, -0.5f,	0.23f,	0.34f,		0.0f,	0.0f,	1.0f,
		0.5f, -0.5f, -0.5f,		0.0f,	0.34f,		0.0f,	0.0f,	1.0f,
		0.5f,  0.5f, -0.5f,		0.0f,	0.66f,		0.0f,	0.0f,	1.0f,
		-0.5f,  0.5f, -0.5f,	0.23f,	0.66f,		0.0f,	0.0f,	1.0f,
		...
		//UP
		 ...
		 0.5f,  0.5f,  0.5f,	0.74f,	0.68f,		0.0f,	-1.0f,	0.0f,
		  0.5f, 0.5f,  -0.5f,	0.74f,	0.98f,		0.0f,	-1.0f,	0.0f,
...
int main()
{
	...
	dadoTexture = Texture("Textures/dado_animales4.tga");
