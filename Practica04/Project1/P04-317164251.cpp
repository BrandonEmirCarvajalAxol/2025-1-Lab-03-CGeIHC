...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::scale(model, glm::vec3(2.5f, 10.0f, 2.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//la línea de proyección solo se manda una vez a menos que en tiempo de ejecución
		//se programe cambio entre proyección ortogonal y perspectiva
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.8039f, 0.8039f, 0.8039f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //color magenta para cabina
		meshList[2]->RenderMeshGeometry(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular
		model = modelaux;

		//Cuello
		model = glm::translate(model, glm::vec3(-4.3f, 3.2f, 0.0f));
		modelaux3 = model;
		model = glm::rotate(model, glm::radians(28.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(1.3f, 3.5f, 1.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.8039f, 0.8039f, 0.8039f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //color magenta para cabina
		...
		model = modelaux3;
		//Oreja 1
		model = glm::translate(model, glm::vec3(0.0f, 2.8f, -0.7f));
		model = glm::scale(model, glm::vec3(2.5f, 2.5f, 2.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.7841f, 0.7841f, 0.7841f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh();
		//Oreja 2
		model = modelaux3;
		model = glm::translate(model, glm::vec3(0.0f, 2.8f, 1.6f));
		model = glm::scale(model, glm::vec3(2.5f, 2.5f, 2.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.7841f, 0.7841f, 0.7841f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		model = modelaux;
		//articulación 1 de extremidad 1
		model = glm::translate(model, glm::vec3(-3.0f, -1.0f, 2.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //color azul para articulación
		sp.render();
		model = modelaux2;
		//parte 1 de extremidad 1
		...
		model = modelaux2;
		//articulación 2 de extremidad 1
		...
		sp.render();
		model = modelaux2;
		//parte 2 de extremidad 1
		model = glm::translate(model, glm::vec3(-0.5f, -1.2f, 0.0f));
		modelaux2 = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(30.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.8f, 2.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.8039f, 0.8039f, 0.8039f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		//articulación 1 de extremidad 2
		model = glm::translate(model, glm::vec3(3.0f, -1.0f, 2.5f));
		...
		meshList[0]->RenderMesh();
		model = modelaux2;
		//articulación 2 de extremidad 2
		model = glm::translate(model, glm::vec3(0.8f, -1.5f, 0.0f));
		...
		//articulación 1 de extremidad 3
		model = glm::translate(model, glm::vec3(-3.0f, -1.0f, -2.5f));
		...
		meshList[0]->RenderMesh();
		model = modelaux2;
		//articulación 2 de extremidad 3
		model = glm::translate(model, glm::vec3(0.8f, -1.5f, 0.0f));
		...
		//articulación 1 de extremidad 4
		model = glm::translate(model, glm::vec3(3.0f, -1.0f, -2.5f));
		...
		meshList[0]->RenderMesh();
		model = modelaux2;
		//articulación 2 de extremidad 4
		model = glm::translate(model, glm::vec3(0.8f, -1.5f, 0.0f));
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion9()), glm::vec3(1.0f, 1.0f, 1.0f));
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		...
		model = glm::translate(model, glm::vec3(2.4f, 2.4f, 0.3f));
		model = glm::rotate(model, glm::radians(-45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(1.3f, 6.0f, 1.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.7841f, 0.7841f, 0.7841f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh();
		...
		// Llantas detalnteras
		model = glm::translate(model, glm::vec3(-2.0f, -1.5f, 1.9f)); // Primera llanta
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f)); // Ajuste de tamaño para la llanta
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry(); // Dibujar cilindro como llanta
		model = modelaux2;

		model = glm::translate(model, glm::vec3(-2.0f, -1.5f, -1.9f)); // Segunda llanta
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f)); // Ajuste de tamaño para la llanta
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// Llantas traseras
		model = glm::translate(model, glm::vec3(2.0f, -1.5f, 1.9f)); // Tercera llanta
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::translate(model, glm::vec3(2.0f, -1.5f, -1.9f)); // Cuarta llanta
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion8()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //color cyan para brazo
		meshList[0]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular
		...
		modelaux = model;
		//dibujar una pequeña esfera
		model = glm::scale(model, glm::vec3(0.8f, 1.0f, 0.9f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //color azul para articulación
		sp.render();
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //color amarillo para canasta
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
